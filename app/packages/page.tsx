    ...
    <div className="min-h-screen bg-neutral-900 py-10 sm:py-14">
      ...
      <div className="mx-auto max-w-5xl space-y-7 px-4 sm:px-6 lg:px-8">
        ...
        <section aria-label="Installation method" className="grid gap-3 sm:grid-cols-2">
          {([
            ...
            >
              ...
              {item.detail && <span className="mt-2 block text-xs leading-5 text-gray-400">{item.detail}</span>}
            </button>
          ))}
        </section>
        ...
        {state === null ? (
          ...
          <>
            <section aria-label="Docker setup" className="grid grid-cols-2 gap-2 rounded-xl border border-neutral-700 bg-neutral-900/80 p-1">
            ...
            {dockerSetup === "guided" ? (
              <section id="install" className={panelClass}>
                <h2 className="text-2xl font-bold text-white">1. Set up in VS Code</h2>
                <p className="mb-4 mt-3 text-sm leading-6 text-gray-300">
                ...
                <p id="install-vscode-caption" className="mt-3 text-sm leading-6 text-gray-400">
                  Requires <a href="https://code.visualstudio.com/" className={linkClass}>VS Code</a>.
                  You may be prompted to install the{" "}
                  <a href={documentdbVsCodeExtensionMarketplaceUrl} className={linkClass}>DocumentDB extension</a>.
                </p>
                <h2 className="mt-8 text-2xl font-bold text-white">2. Run your first query</h2>
        ...
        <section id="downloads" className="space-y-4" aria-label="Advanced downloads and troubleshooting">
          ...
          <details className={panelClass}>
            ...
            <ul className="mt-4 list-disc space-y-3 pl-5 text-sm leading-6 text-gray-300">
              ...
              <li>Missing shell: mongosh is not included in the Linux package set; install it separately.</li>
